...
export const dataAuditService = {
  ...
  getByCorrelation: (correlationId) => api.get(`/data/correlation/${correlationId}`),
  getStatsByTable: (params) => api.get('/data/stats/by-table', { params }),
  getStatsByUser: (params) => api.get('/data/stats/by-user', { params }),
  getStatsByOperation: (params) => api.get('/data/stats/by-operation', { params }),
  getStatsByEndpoint: (params) => api.get('/data/stats/by-endpoint', { params }),
...
export const accessAuditService = {
  ...
  getByCorrelation: (correlationId) => api.get(`/access/correlation/${correlationId}`),
  ...
  getStatsByEndpoint: (params) => api.get('/access/stats/by-endpoint', { params }),
  getSlowRequests: (params) => api.get('/access/stats/slow-requests', { params }),
  getGeoStats: (params) => api.get('/access/stats/geo', { params }),
  getStatsByIp: (params) => api.get('/access/stats/by-ip', { params }),
  getEndpointTimeline: (params) => api.get('/access/stats/endpoint-timeline', { params }),
}
